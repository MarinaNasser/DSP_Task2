...
def generate_sliders(sliders_num,max_freq,flag=True):
        ...
        for i in range(0, sliders_num):
            with columns[i]:
                ...
                # ,slider_color= 'darkcyan'
                # ,track_color='lightgray'
                # ,thumb_color = 'darkcyan'
                )
                if flag:
                    ...
                    if i==0:
                        with columns[0]:
                            st.write("Bradycardia")
                    elif i==1:
                        with columns[1]:
                           st.write("Normal Sinus Rhythm")
                    elif i==2:
                        with columns[2]:
                           st.write("Sinus Tachyardia")
                    elif i==3:
                        with columns[3]:
                           st.write("Atrial Tachycatdia")
                if slider == None:
                    slider = 1
...
#----------------------------------------------------------------------Signal Modification-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------       
def signal_modification(points_per_freq,frequencies,max_freq,sliders_num,amplitude,sliders_data):
    empty = st.empty()
    empty.empty()
