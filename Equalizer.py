...
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    modified_file=ipd.Audio(ifft_file,rate=samplerate/2)
    empty.write(modified_file)
    frequency= sample_frequency[:len(mod_amplitude_axis_list):1]




    # functions.plottingInfreqDomain(amplitude, sample_frequency, mod_amplitude_axis_list, sample_frequency)
