...
#----------------------------------------------------------------------Sliders-------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    functions.generate_sliders(3,10,False)
else:
...
#-------------------------------------------------------generate sliders/signal-modification--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    if  option=='Musical Instruments Mode' :
        ...
        mod_amplitude_axis_list,empty= functions.signal_modification(points_per_freq,frequencies,max_freq,sliders_num,amplitude,sliders_data)
#------------------------------------------------------------------------Static-plotting--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
